...
export const UpcomingBatchesPage: React.FC<UpcomingBatchesPageProps> = ({
  ...
  useEffect(() => {
    const targetDate = new Date('2026-09-26T10:00:00+05:30').getTime();
    ...
    <div className="upcoming-batches-wrapper">
      ...
      <section className="ub-hero-section">
        ...
        <div className="container ub-hero-content">
          <div className="ub-urgency-badge">
            ...
            <span>NEXT BATCHES LAUNCHING SEPTEMBER 26TH, 2026</span>
          </div>
          ...
          <div className="ub-timer-wrapper">
            <div className="ub-timer-label">September 26 Batch Countdown • Limited Seats Remaining</div>
      ...
      <section className="ub-trends-section container">
        <div className="ub-section-title-area">
          ...
          <h2 className="ub-section-heading">Why You Should Enroll in the September 26 Batch</h2>
      ...
      <section id="batches-schedule" className="ub-batches-section container">
        <div className="ub-section-title-area">
          <span className="ub-section-tag">Flagship Programs • September 26 Batch</span>
        ...
        <div className="ub-batches-grid">
          ...
          <div className="ub-batch-card featured-batch">
            ...
            <div className="ub-card-actions">
              ...
              >
                Request Callback for Sep 26 Batch
              </button>
            </div>
          </div>
          ...
          <div className="ub-batch-card">
            <div className="ub-batch-top-row">
              ...
              <span className="ub-seat-badge">7 Seats Remaining</span>
            </div>
        ...
        <div className="ub-cta-banner">
          <h2>Seats Are Filling Fast for September 26th</h2>
          <p>
          ...
          >
            Request Immediate Callback for Sep 26 Batch
          </button>
        </div>
      </section>
    </div>
